...
* JavaScript (ES6)
* Biblioteca p5.js (v1.9.0)
* HTML5 / CSS3

## Licenças e Recursos de Terceiros
* Todos os gráficos e interfaces foram desenhados proceduralmente utilizando as funções nativas de renderização geométrica do p5.js.
* Não foram utilizados assets proprietários com direitos autorais. Todo o código é autoral sob a licença MIT.
